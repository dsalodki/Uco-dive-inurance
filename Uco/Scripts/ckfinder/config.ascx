...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
		...
		if(HttpContext.Current.User.IsInRole("Admin")) return true;
		else return false;
	}
	...
	public override void SetConfig()
	{
		...
		type.Url = BaseUrl + "Document/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Document/";
		type.MaxSize = 0;
		...
		type = ResourceType.Add( "Upload" );
		type.Url = BaseUrl + "Upload/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Upload/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "swf", "flv", "bmp", "gif", "jpeg", "jpg", "png", "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
		type.DeniedExtensions = new string[] { };
		
		type = ResourceType.Add( "Gallery" );
		type.Url = BaseUrl + "Gallery/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "Gallery/";
		type.MaxSize = 0;
		type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png" };
		type.DeniedExtensions = new string[] { };
	}
